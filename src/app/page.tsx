...
import StoresDownloader from './../components/download/StoresDownloader';
      ...
      <main>
        <div className=''>
          <div className="flex flex-col justify-center items-center">
            <motion.h1
              className="box text-mainDark font-bold text-[350px] pointer-events-none"
            ...
            <motion.h2 variants={containerVariants} initial="hidden" animate="visible" className={`${mark.className} text-mainRose text-[200px] absolute bottom-[280px]  pointer-events-none`}>
